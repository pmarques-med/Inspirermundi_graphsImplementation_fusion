...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    /**
     * Title text used when no title is provided by the bloomidea.com.lisboacool.adapter.
     */
    ...
    public void setViewPager(ViewPager view) {
        ...
        if (view.getAdapter() == null) {
            throw new IllegalStateException("ViewPager does not have bloomidea.com.lisboacool.adapter instance.");
        }
        mViewPager = view;
