...
public class MorebiRoundedTimerTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public MorebiRoundedTimerTextView(Context context) {
        super(context);
    }

    public MorebiRoundedTimerTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MorebiRoundedTimerTextView(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            if (timerDate.getTimeInMillis() > today.getTimeInMillis()) {
                ...
                timer = new CountDownTimer(difInicical, 1000) {
                    public void onTick(long millisUntilFinished) {
                        ...
                        MorebiRoundedTimerTextView.this.setText(timerFormatter.format(h)+":"+timerFormatter.format(m)+":"+timerFormatter.format(s)+" ");
                    }
                    ...
                    public void onFinish() {
                        ...
                        MorebiRoundedTimerTextView.this.setText("");
                    }
                }.start();
            } else {
                this.setText("");
