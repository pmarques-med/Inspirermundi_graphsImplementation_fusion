...
public class BorderProgressBar extends View {
    ...
    private int DEFAULT_RADIUS = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, getResources().getDisplayMetrics());
    private int DEFAULT_BORDER_COLOR = Color.parseColor("#000000");
    private int DEFAULT_PROGRESS_COLOR = Color.parseColor("#000000");
    ...
    private boolean DEFAULT_SHOWDESC = true ;
    ...
    public BorderProgressBar(Context context, AttributeSet attrs) {
    ...
    public BorderProgressBar(Context context, AttributeSet attrs,
        ...
        TypedArray def = context.obtainStyledAttributes(attrs, R.styleable.BorderProgressBar);
        try {
            mMax = def.getInt(R.styleable.BorderProgressBar_max, DEFAULT_MAX);
            mProgress = def.getInt(R.styleable.BorderProgressBar_progress, DEFAULT_PROGRESS);
            mRadius = (int) def.getDimension(R.styleable.BorderProgressBar_progressRadius, DEFAULT_RADIUS);
            mProgressColor = def.getColor(R.styleable.BorderProgressBar_progressColor, DEFAULT_PROGRESS_COLOR);
            mProgressDescColor = def.getColor(R.styleable.BorderProgressBar_progressDescColor, DEFAULT_PROGRESS_DESC_COLOR);
            mBorderWidth = (int) def.getDimension(R.styleable.BorderProgressBar_borderWidth, DEFAULT_BORDER_WIDTH);
            mProgressDesc = def.getString(R.styleable.BorderProgressBar_progressDesc);
            mShowDesc = def.getBoolean(R.styleable.BorderProgressBar_isShowDesc,DEFAULT_SHOWDESC) ;
        } finally {
            def.recycle();
        }
